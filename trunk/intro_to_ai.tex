...
\Tree [.c1 [.N b1 c1 ] [.S c1 c2 ] W E ]

\noindent In general, each action will have 3 possible outcomes. Thus, every two levels that we descend could create up to 12 new nodes.
...
\put(20,30){\line(-1,0){15}}
\put(5,30){\line(0,-1){14}}
\put(5,16){\vector(1,0){14}}
\put(6,6){0.6}

\put(30,28){\vector(1,0){28}}
\put(38,30){0.4}
\put(58,18){\vector(-1,0){28}}
\put(40,9){0.2}

\put(67,30){\line(1,0){15}}
