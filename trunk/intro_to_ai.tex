...
\put(22,2){\circle{4}}
\put(26,2){\circle{4}}
\put(20,11){\line(-2,-1){14}}
\put(20,9){\line(-2,-1){10}}
...
\end{itemize_packed}
A solution to these problems is to work with belief states instead of actual states.
...
\begin{center}
\begin{picture}(300,200)
%TODO: draw belief states for sensorless vacuum example
\put(100,100){\usebox{\vacVD}}
\put(132,100){\usebox{\vacV}}
\put(164,100){\usebox{\vacD}}
\put(196,100){\usebox{\vac}}
\end{picture}
\end{center}
