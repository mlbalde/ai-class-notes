...
\put(0,0){\framebox(300,310)}

% Initial state
\put(100,230){\vacBoxEight}
\put(103,260){\vector(-1,0){19}}
\put(92,262){L}
\put(224,260){\vector(1,0){19}}
\put(230,262){R}


% Move L from initial
\put(0,240){\vacBoxFour{\vacone}{\vacthree}{\vacfive}{\vacseven}}
\put(70,280){\line(0,1){20}}
\put(70,300){\line(1,0){180}}
\put(250,300){\vector(0,-1){20}}
\put(72,288){R}

% Move R from initial
\put(240,240){\vacBoxFour{\vactwo}{\vacfour}{\vacsix}{\vaceight}}
\put(260,280){\line(0,1){30}}
\put(260,310){\line(-1,0){200}}
\put(60,310){\vector(0,-1){30}}
\put(262,288){L}

% Suck from initial
\put(120,160){\vacBoxFour{\vacfour}{\vacfive}{\vacseven}{\vaceight}}

% L->S
\put(0,80){\vacBoxTwo{\vacfive}{\vacseven}}

% S->L
\put(65,80){\vacBoxFour{\vacfive}{\vacthree}{\vacseven}{\vacempty}}

% S->R
\put(175,80){\vacBoxFour{\vacsix}{\vacfour}{\vaceight}{\vacempty}}

% R->S
\put(280,80){\vacBoxTwo{\vacfour}{\vaceight}}
