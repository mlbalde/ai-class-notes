...
\begin{picture}(100,1000)
\setlength{\unitlength}{1pt}
\put(0,0){\framebox(300,420)}
% Count 40x20 for each state

% Initial state
\put(100,300){\vacBoxEight}

% Move L from initial
\put(0,300){\vacBoxFour{\vacone}{\vacthree}{\vacfive}{\vacseven}}

% Move R from initial
\put(240,300){\vacBoxFour{\vactwo}{\vacfour}{\vacsix}{\vaceight}}

% Suck from initial
\put(120,240){\vacBoxFour{\vacfour}{\vacfive}{\vacseven}{\vaceight}}
